...
class TestController extends AbstractController
{
            ...
            for ($i = 0; $i <= sizeof($dbaListeerps) - 2; $i++) {
                if ($dbaListeerps[$i]->getListeerpNumeroVoie() == '') {
                    ...
                    $data[] = array(
                        ...
                        'latitude' => $dbaListeerps[$i]->getListeerpLatitude()
                    );
    ...
    public function testActiviteAction()
    {
            ...
            for ($i = 0; $i <= sizeof($dbaListeerps) - 2; $i++) {
                if ($dbaListeerps[$i]->getListeerpNumeroVoie() == '') {
                    $data[] = array(
                        'name' => $dbaListeerps[$i]->getListeErpNomErp(),
                        'adress' => $dbaListeerps[$i]->getListeerpNomVoie(),
                        'activite' => $dbaListeerps[$i]->getListeerpType(),
                        'latitude' => $dbaListeerps[$i]->getListeerpLatitude(),
                        'longitude' => $dbaListeerps[$i]->getListeerpLongitude()
                    );
                } else {
                    $data[] = array(
                        'name' => $dbaListeerps[$i]->getlisteErpNomErp(),
...
*/
            ...
            switch ($activite) {
                case 'Structures d’accueils personnes agées ou handicapés':
                    $activite = 'J';
                    break;
                case 'Salles de réunions, spectacle, concert, confédérations':
                    $activite = 'L';
                    break;
                case 'Magasins de vente, centres commerciaux':
                    $activite = 'M';
                    break;
                case 'Restaurants débits de boisson':
                    $activite = 'N';
                    break;
                case 'Hotels et pensions de famille':
                    $activite = 'O';
                    break;
                case 'Salles de danse et salles de jeux':
                    $activite = 'P';
                    break;
                case 'Etablissements d’enseignement, colonies de vacances':
                    $activite = 'R';
                    break;
                case 'Bibliothèques, centres de documentation':
                    $activite = 'S';
                    break;
                case 'Salles d’exposition':
                    $activite = 'T';
                    break;
                case 'Etablissements sanitaires':
                    $activite = 'U';
                    break;
                case 'Etablissements de culte':
                    $activite = 'V';
                    break;
                ...
                case 'Musées':
                    $activite = 'Y';
                    break;
                case 'Etablissements de plein air':
                    $activite = 'PA';
                    break;
                case 'Chapiteaux, tentes et structures itinérantes':
                    $activite = 'CTS';
                    break;
                case 'Structures gonflables':
                    $activite = 'SG';
                    break;
                case 'Parcs de stationnement couverts':
                    $activite = 'PS';
                    break;
                case 'Hotels-restaurants d’altitude':
                    $activite = 'OA';
                    break;
                case 'Gares accessiblesau public':
                    $activite = 'GA';
                    break;
                case 'Etablissements flottants, bateaux stationnaires':
                    $activite = 'EF';
                    break;
                case 'Refuges de montagne':
                    $activite = 'REF';
                    break;
            }
